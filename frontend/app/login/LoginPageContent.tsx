    ...
    <section className="mx-auto grid max-w-6xl gap-10 px-4 py-12 sm:px-6 lg:grid-cols-[1fr_420px] lg:px-8">
      ...
      <div className="rounded border border-line bg-white p-6 shadow-sm">
        ...
        <form onSubmit={handleSubmit} className="mt-6 grid gap-4">
          ...
          <button
            className="mt-2 rounded bg-ink px-5 py-3 text-sm font-bold text-white transition hover:bg-teal disabled:cursor-not-allowed disabled:opacity-50"
            type="submit"
            disabled={isLoading}
          >
        ...
        <p className="mt-5 text-sm text-ink/65">
          New here?{" "}
          <Link className="font-bold text-teal" href="/signup">
            Create an account
          </Link>
        </p>
      </div>
