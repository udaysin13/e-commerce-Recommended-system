    ...
    <section className="mx-auto grid max-w-6xl gap-10 px-4 py-12 sm:px-6 lg:grid-cols-[420px_1fr] lg:px-8">
      <div className="rounded border border-line bg-white p-6 shadow-sm">
        ...
        <form onSubmit={handleSubmit} className="mt-6 grid gap-4">
          ...
          <button
            className="mt-2 rounded bg-teal px-5 py-3 text-sm font-bold text-white transition hover:bg-ink disabled:opacity-50 disabled:cursor-not-allowed"
            type="submit"
            disabled={isLoading}
          >
        ...
        <p className="mt-5 text-sm text-ink/65">
          Already have an account? <Link className="font-bold text-teal" href="/login">Log in</Link>
        </p>
      </div>
